...
export default function DrillingEntryModal({ onClose, onSuccess, isInline = false }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setForm(prev => ({
                ...prev,
                drillingHours: '0', mechanicalDowntime: '0', operationalDelay: '0',
                weatherDowntime: '0', safetyDowntime: '0', waitingOnParts: '0', standbyHours: '0',
                metersDrilled: '', holeDepth: '', bitType: '', fuelConsumed: '', consumablesCost: '', remarks: ''
            }));
    ...
    const content = (
        <div className={`relative w-full ${isInline ? 'max-w-none' : 'max-w-4xl max-h-[90vh] overflow-y-auto m-4 shadow-2xl scale-in'} rounded-2xl bg-[#111827] border border-slate-800/50`}>
            {/* Header */}
